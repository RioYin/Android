 ...
 */
public class CharacterZEXALActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zexal_character_layout);
        dbHelper = new CharacterOpenHelper(this, "Card.db", null, 1);

        initDM();
        CharacterAdapter adapter = new CharacterAdapter(CharacterZEXALActivity.this, R.layout.dm_item, dmList);


        ListView listView = (ListView) findViewById(R.id.list_view_zexal);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                showInfo(position);
                Intent intent = new Intent(CharacterZEXALActivity.this, CharacterCardActivity.class);
    ...
    private void initDM() {
        DM dm1 = new DM("九十九游马（Tsukumo Yuma）", R.drawable.tsukumoyuma);
        dmList.add(dm1);
        DM dm2 = new DM("星光体 （Astral）", R.drawable.astral);
        dmList.add(dm2);
        DM dm3 = new DM("天城快斗 (Tenjo Kaito)", R.drawable.tenjokaito);
        dmList.add(dm3);
        DM dm4 = new DM("神代凌牙 / 纳修 (Kamishiro Ryoga / Nasshu)", R.drawable.kamishiroryoga);
        dmList.add(dm4);
        DM dm5 = new DM("观月小鸟 (Mizuki Kotori)", R.drawable.mizukikotori);
        dmList.add(dm5);
        DM dm6 = new DM("武田铁男 (Takeda Tetsuo)", R.drawable.takedatetsuo);
        dmList.add(dm6);
        DM dm7 = new DM("表里德之助 (Hyori Tokunosuke)", R.drawable.hyoritokunosuke);
        dmList.add(dm7);
        DM dm8 = new DM("小猫 (Cathy Katherine)", R.drawable.cathykatherine);
        dmList.add(dm8);
        DM dm9 = new DM("等等力孝 (Todoroki Takashi)", R.drawable.todorokitakashi);
        dmList.add(dm9);
        DM dm10 = new DM("神月安奈 (Kozuki Anna)", R.drawable.kozukianna);
        dmList.add(dm10);
        DM dm11 = new DM("神代璃绪 / 梅拉古 (Kamishiro Rio / Meragu)", R.drawable.kamishirorio);
        dmList.add(dm11);
        DM dm12 = new DM("真月零 / 贝库塔 (Shingetsu Rei / Bekuta)", R.drawable.shingetsurei);
        dmList.add(dm12);
        DM dm13 = new DM("米歇尔•阿克雷德 / Ⅲ (Mihairu Akuraito / Suri)", R.drawable.mihairuakuraito);
        dmList.add(dm13);
        DM dm14 = new DM("托马斯·阿克雷德 / IV (Tomasu Akuraito / Fo)", R.drawable.tomasuakuraito);
        dmList.add(dm14);
        DM dm15 = new DM("克里斯多弗·阿克雷德 / V (Kurisutofa Akuraito / Bui)", R.drawable.kurisutofakuraito);
        dmList.add(dm15);
        DM dm16 = new DM("拜隆·阿克雷德 / 玉座 (Bairon Akuraito / Toron)", R.drawable.baironakuraito);
        dmList.add(dm16);
        DM dm17 = new DM("菲卡博士 (Dokuta Feika)", R.drawable.dokutafeika);
        dmList.add(dm17);
        DM dm18 = new DM("心城先生 (Misuta Hatorando)", R.drawable.misutahatorando);
        dmList.add(dm18);
        DM dm19 = new DM("戈什 (Goshu)", R.drawable.goshu);
        dmList.add(dm19);
        DM dm20 = new DM("德鲁瓦 (Dorowa)", R.drawable.dorowa);
        dmList.add(dm20);
        DM dm21 = new DM("埃利法斯 (Erifasu)", R.drawable.erifasu);
        dmList.add(dm21);
        DM dm22 = new DM("No.96 黑雾 (Nanbazu Kyujuroku Burakku Misuto)", R.drawable.nanbazukyujurokuburakkumisuto);
        dmList.add(dm22);
        DM dm23 = new DM("基拉古 (Giragu)", R.drawable.giragu);
        dmList.add(dm23);
        DM dm24 = new DM("阿里特 (Arito)", R.drawable.arito);
        dmList.add(dm24);
        DM dm25 = new DM("米扎艾尔 (Mizaeru)", R.drawable.mizaeru);
        dmList.add(dm25);
        DM dm26 = new DM("德鲁贝 (Dorube)", R.drawable.dorube);
        dmList.add(dm26);
        DM dm27 = new DM("上千主上 (Don Sauzando)", R.drawable.donsauzando);
        dmList.add(dm27);
    ...
    public void showInfo(int position) {
        ...
        switch (position) {
            ...
            case 3:
                ...
                db.execSQL("insert into MonsterCard (title, type, attack,defence,level_rank) values(?, ?, ?, ?, ?)",    new String[] { "No.101 寂静荣誉方舟骑士", "超量怪兽", "2100","1000","阶级4"});
                db.execSQL("insert into MonsterCard (title, type, attack,defence,level_rank) values(?, ?, ?, ?, ?)",    new String[] { "被封印者的左足", "通常怪兽", "200","300","等级1"});
                db.execSQL("insert into MonsterCard (title, type, attack,defence,level_rank) values(?, ?, ?, ?, ?)",    new String[] { "被封印者的右足", "通常怪兽", "200","300","等级1"});
                db.execSQL("insert into MonsterCard (title, type, attack,defence,level_rank) values(?, ?, ?, ?, ?)",    new String[] { "被封印者的左腕", "通常怪兽", "200","300","等级1"});
                db.execSQL("insert into MonsterCard (title, type, attack,defence,level_rank) values(?, ?, ?, ?, ?)",    new String[] { "被封印者的右腕", "通常怪兽", "200","300","等级1"});
