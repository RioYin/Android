 ...
 */
public class CharacterFIVEDSActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fiveds_character_layout);
        dbHelper = new CharacterOpenHelper(this, "Card.db", null, 1);

        initDM();
        CharacterAdapter adapter = new CharacterAdapter(CharacterFIVEDSActivity.this, R.layout.dm_item, dmList);


        ListView listView = (ListView) findViewById(R.id.list_view_5ds);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                showInfo(position);
                Intent intent = new Intent(CharacterFIVEDSActivity.this, CharacterCardActivity.class);
    ...
    private void initDM() {
        DM dm1 = new DM("不动游星（Fudo Yusei）", R.drawable.fudoyusei);
        dmList.add(dm1);
        DM dm2 = new DM("杰克·阿特拉斯 (Jack Atlas)", R.drawable.jackatlas);
        dmList.add(dm2);
        DM dm3 = new DM("十六夜秋 (Izayoi Aki)", R.drawable.izayoiaki);
        dmList.add(dm3);
        DM dm4 = new DM("克罗·霍根 (Crow Hogan)", R.drawable.crowhogan);
        dmList.add(dm4);
        DM dm5 = new DM("龙亚 (Lua)", R.drawable.lua);
        dmList.add(dm5);
        DM dm6 = new DM("龙可 (Luka)", R.drawable.luka);
        dmList.add(dm6);
        DM dm7 = new DM("鬼柳京介 (Kiryu Kyosuke)", R.drawable.kiryukyosuke);
        dmList.add(dm7);
        DM dm8 = new DM("卡莉渚 (Carly Nagisa)", R.drawable.carlynagisa);
        dmList.add(dm8);
        DM dm9 = new DM("密丝缇·劳拉 (Misuti Rora)", R.drawable.misutirora);
        dmList.add(dm9);
        DM dm10 = new DM("波马 (Bommer)", R.drawable.bommer);
        dmList.add(dm10);
        DM dm11 = new DM("迪马克 (Demak)", R.drawable.demak);
        dmList.add(dm11);
        DM dm12 = new DM("鲁德格·哥德温 (Rudger Goodwin)", R.drawable.rudgergoodwin);
        dmList.add(dm12);
        DM dm13 = new DM("雷克斯·哥德温 (Rex goodwin)", R.drawable.rexgoodwin);
        dmList.add(dm13);
        DM dm14 = new DM("帕拉多克斯 (Paradox)", R.drawable.paradox);
        dmList.add(dm14);
        DM dm15 = new DM("安提诺米 (Antinomy)", R.drawable.antinomy);
        dmList.add(dm15);
        DM dm16 = new DM("阿波利亚 (Aporia)", R.drawable.aporia);
        dmList.add(dm16);
        DM dm17 = new DM("域 (Z-ONE)", R.drawable.zone);
        dmList.add(dm17);
        DM dm18 = new DM("牛尾哲 (Ushio Tetsu)", R.drawable.ushiotetsu);
        dmList.add(dm18);
        DM dm19 = new DM("耶戈 (Yeager)", R.drawable.yeager);
        dmList.add(dm19);
        DM dm20 = new DM("迪威恩 (Divain)", R.drawable.divain);
        dmList.add(dm20);
        DM dm21 = new DM("雪莉·卢布朗 (Sherry LeBlanc)", R.drawable.sherryleblanc);
        dmList.add(dm21);
    ...
    public void showInfo(int position) {
        ...
        switch (position) {
            ...
            case 16:
                ...
                db.execSQL("insert into MonsterCard (title, type, attack,defence,level_rank) values(?, ?, ?, ?, ?)",    new String[] { "时械神 梅塔伊恩", "效果怪兽", "0","0","等级10"});
                db.execSQL("insert into MonsterCard (title, type, attack,defence,level_rank) values(?, ?, ?, ?, ?)",    new String[] { "被封印者的左足", "通常怪兽", "200","300","等级1"});
                db.execSQL("insert into MonsterCard (title, type, attack,defence,level_rank) values(?, ?, ?, ?, ?)",    new String[] { "被封印者的右足", "通常怪兽", "200","300","等级1"});
                db.execSQL("insert into MonsterCard (title, type, attack,defence,level_rank) values(?, ?, ?, ?, ?)",    new String[] { "被封印者的左腕", "通常怪兽", "200","300","等级1"});
                db.execSQL("insert into MonsterCard (title, type, attack,defence,level_rank) values(?, ?, ?, ?, ?)",    new String[] { "被封印者的右腕", "通常怪兽", "200","300","等级1"});
